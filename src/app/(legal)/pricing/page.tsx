  ...
  return (
    <article className="space-y-6">
      ...
      <ul className="ml-5 list-disc space-y-1.5 text-sm text-muted-foreground">
        ...
        <li>რეგიონებში მიწოდების სავარაუდო ვადა ნაჩვენებია შეკვეთის დადასტურებამდე.</li>
        <li>
          ამანათის კურიერისთვის გადაცემის შემდეგ გაუქმებისას დაბრუნების ტარიფი შეადგენს შესაბამისი
          მიტანის ფასის 50%-ს.
        </li>
      </ul>
