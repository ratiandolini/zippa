          ...
          <Card>
            ...
            <CardContent className="grid gap-4 sm:grid-cols-2">
              ...
              <Text
                ...
                type="number"
                step="1"
                hint="შეავსე მხოლოდ მაშინ, თუ მიმღებმა ნივთის ფასი კურიერთან ნაღდად უნდა გადაიხადოს (მაგ. მაღაზიის შეკვეთა). კურიერი ამ თანხას აიღებს მიმღებისგან და Zippa გადმოგირიცხავს. სხვა შემთხვევაში დატოვე ცარიელი."
